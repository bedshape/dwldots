...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xa89983ff, 0x141414ff, 0x282828ff },
	[SchemeSel]  = { 0xebdbb2ff, 0x295340ff, 0xb8ba25ff },
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_backslash,  setlayout,      {.v = &layouts[1]} },
	{ MODKEY,                    XKB_KEY_f,          setlayout,      {.v = &layouts[2]} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Tab,        setlayout,      {0} },
